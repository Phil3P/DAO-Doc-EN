# Phase 1: Setup and Objectives

## 3.1. Explanation of the simplified version

### ⭐ For beginners

Phase 1 of the RealToken DAO is a simplified version of the final system. It's like a trial period where we set up the basics of the DAO. During this phase, we learn how governance works and we start making decisions together, but in a simpler way than in the future. The DAO's power is limited for now to reduce risks and allow for gradual learning; the scope of decision-making power will increase over time.
...
This phase uses a limited set of smart contracts and features to facilitate adoption and learning. The technological choice was made so that this first phase allows for rapid and simple deployment with limited development costs. This phase will therefore allow accumulating knowledge and establishing fundamental basic principles for the future of the DAO and the new version in phase 2 with the arrival of NFTs.
...
1. Simplified governance:
   * Basic voting mechanism taken from the OpenZeppelin governor standard,
   * Evolving and less rigid proposal process to allow for greater participation and flexibility of exploration,
...
2. Basic smart contracts:
   * Governance contract, with voting and proposal functions, taken from Open Zeppelin standards,
   * Simple treasury contract for DAO fund management,
   * Incentive contract for managing voting incentive rewards,
   * PowerVotingRegistry contract, allowing to register the voting power of each REG holder.
...
This phase will serve as a basis for the future evolution of the DAO, allowing to identify necessary adjustments and features to develop for subsequent phases. By using this phase as a laboratory, we can experiment with various governance approaches and data collection before integrating these into the next version of the DAO with the arrival of NFTs. Although piloted by the trusted partner RealT, the DAO will remain independent and decisions will always be made by DAO members within the progressively expanded scope of application. Several points will therefore need to be debated between REG holders and RealT to establish the stages of expanding the DAO's scope of application to ensure the stability and security of the ecosystem.

## 3.2. Setup process

### ⭐ For beginners

The DAO setup is done step by step. First, we create the basic tools for voting and making proposals. Then, we start using them to make simple decisions. As we go along, we learn and improve the system together.

### ⭐⭐ For the initiated

The setup process for Phase 1 includes several key steps:
...
3. Training the community on the use of governance tools,
4. Presentation of the first projects the DAO can vote on (RealT has already prepared a series of proposals),
5. Setting up the discussion and debate system for proposals (community devs have already worked on a solution),
6. Launch of the first proposals,
7. Launch of the first voting incentive campaign,
8. Adjustment of governance parameters based on feedback,
9. Gradual expansion of the DAO's scope of action.

### ⭐⭐⭐ For experts

The setup process for Phase 1 is structured to maximize learning and adaptation:
...
2. Initial governance:
   * Definition of initial parameters (quorum, voting thresholds, timelock: RealT),
   * Implementation of a multi-step proposal process (discussion, formalization, vote),
   * Implementation of security mechanisms, including RealT's veto right,
   * Limitation of access to proposal creation.
...
4. Iteration and optimization:
   ...
   * Regular adjustments of governance parameters,
...
This process is designed to be flexible and adaptable, allowing the community to actively influence the evolution of the DAO while maintaining the stability and security of the ecosystem. It also gives REG holders the opportunity to understand and familiarize themselves with DAO mechanisms, create and discover vocations, bring forth ideas and new use cases. The progressive implementation of the DAO thus allows a natural transition and a progressive evolution towards the decentralization of the ecosystem.
...
5. Set up basic processes for governance.
...
4. Prepare the transition to Phase 2 with the integration of NFTs.
...
2. Community engagement:
   ...
   * Create a mentoring program for new active members,
   * Encourage initiatives beneficial to the DAO and the RealToken ecosystem.
3. Technical development:
   * Develop/refine analysis tools to monitor the health of the DAO,
...
2. Innovation and development:
   ...
   * Beginnings of phase 2 with NFT integration.
3. Preparation for Phase 2:
   ...
   * Conduct thorough tests with the community for phase 2.
...
1. Buy REG tokens if you don't already have them,
2. Follow official announcements on RealToken communication channels,
3. Participate in votes when they are open,
4. Give your opinion in community discussions,
5. Attend educational events to learn more about the DAO,
6. Get informed and educated on the topic of DAOs.

### ⭐⭐ For the initiated

Here's how you can actively participate in the initial phase:

1. Vote regularly on proposals,
2. Participate in debates on proposals before votes,
3. Propose improvement ideas in discussion forums,
...
9. Write, improve, translate, and share content about DAOs.
...
1. Governance:
   ...
   * Actively contribute to the development of metrics to assess the health of the DAO,
...
3. Community engagement:
   ...
   * Actively participate in mentoring programs,
   * Explore new concepts for Live, video, article, etc.
4. Innovation:
...
Your active participation at all these levels will help shape the future of the RealToken DAO and ensure its long-term success.
